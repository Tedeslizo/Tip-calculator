...
percentage_chosen = int(input("What percentage tip would you like to give?\n "))
...
input("ah lo necesitay sin propina? ")
print(float(total) / int(people_who_ate))
print("de nada mi bro ocupame cuando gustes")